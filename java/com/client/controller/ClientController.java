...
public class ClientController {
	...
	public String userLogin(@RequestParam("username") String username,@RequestParam("password") String password , Model model,HttpSession session) {
		...
		int status;
		try {
		ResponseEntity<ApplicationUser> res=restTemplate.postForEntity("http://apram-auth-service.herokuapp.com/authservice/auth", user, ApplicationUser.class);
	...
	public String getproducts(HttpSession session) {
		ProductDTO dto=restTemplate.getForObject("https://apram-prod-service.herokuapp.com/productservice/products",ProductDTO.class);
	...
	public String addToCart(@PathVariable("productId") int productId,HttpSession session) {
		...
		for(Product p:list) {
			...
			ResponseEntity<Object> res=restTemplate.postForEntity("https://apram-cart-service.herokuapp.com/cartservice/addItem",cart,Object.class);
			System.out.println(res.getStatusCodeValue());
			}
		}
		return "redirect:/products";
	...
	public String getCartItems(HttpSession session) {
		...
		try {
		dto=restTemplate.getForObject("https://apram-cart-service.herokuapp.com/cartservice/getCartItems",CartDTO.class);
	...
	public String deleteFromCart(@PathVariable("id") int id) {
		restTemplate.delete("https://apram-cart-service.herokuapp.com/cartservice/delete/"+id);
	...
	public String confirmOrder(@RequestParam("address") String address,@RequestParam("mode") String mode, HttpSession session) {
		...
		ResponseEntity<Object> res=restTemplate.postForEntity("https://apram-order-service.herokuapp.com/placeOrder", order, Object.class);
		System.out.println(res.getStatusCodeValue());
		restTemplate.delete("https://apram-cart-service.herokuapp.com/cartservice/deleteAll");
